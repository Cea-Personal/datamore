...
<div className="flex items-center gap-6 mt-4">
                <a href="https://www.facebook.com/datamore.org" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-on-primary-container/90 hover:text-secondary transition-colors">
                ...
                <a href="https://www.linkedin.com/company/datamore.org" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-on-primary-container/90 hover:text-secondary transition-colors">
