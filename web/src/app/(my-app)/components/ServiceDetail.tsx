    ...
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center">
          <div className="md:col-span-7">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-surface-container rounded-full text-secondary mb-6">
              ...
              <span className="text-label-md">{category}</span>
            </div>
            <h1 className="text-display-lg-mobile md:text-display-lg mb-8 text-on-surface" dangerouslySetInnerHTML={{ __html: heroTitle }}>
            </h1>
            <p className="text-body-lg text-on-surface-variant mb-10 max-w-2xl">
              {heroSubtitle}
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-secondary text-on-secondary px-8 py-4 rounded-lg text-label-md hover:brightness-110 shadow-lg transition-all">
                {primaryButtonLabel}
              </button>
              <button className="glass-edge px-8 py-4 rounded-lg text-label-md hover:bg-surface-container transition-all">
                {secondaryButtonLabel}
              </button>
            </div>
          </div>
          <div className="md:col-span-5 relative mt-12 md:mt-0">
            ...
            <div className="absolute -bottom-6 -left-6 bg-surface-container-lowest p-6 rounded-xl tinted-shadow glass-edge hidden lg:block">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-headline-md text-secondary">94%</div>
                  <div className="text-caption text-on-surface-variant">Accuracy Rate</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto bg-surface-container-low rounded-[2rem] my-10">
        <div className="text-center mb-16">
          <h2 className="text-headline-lg text-on-surface mb-4">Core Offerings</h2>
          <p className="text-body-md text-on-surface-variant max-w-xl mx-auto">Enterprise-grade analytics built on the foundation of technical rigor and transparency.</p>
        </div>
            ...
            return (
              ...
              >
                <div>
                  ...
                  <h3 className="text-headline-md mb-4">{offering.title}</h3>
                  <p className="text-body-md text-on-surface-variant max-w-md">
                    {offering.description}
                  </p>
                </div>
                {offering.specsLabel && (
                  <div className="mt-8 flex items-center text-secondary text-label-md cursor-pointer group-hover:gap-2 transition-all">
                    {offering.specsLabel}
      ...
      <section className="py-24 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            <h2 className="text-headline-lg text-on-surface mb-6">Interactive Dashboards: <br /><span className="text-secondary">Precision in Motion</span></h2>
            <div className="space-y-8">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-label-md mb-1">Real-Time Drill-Down</h4>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-label-md mb-1">Cross-Functional Integration</h4>
                  <p className="text-body-md text-on-surface-variant">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-label-md mb-1">Role-Based Granularity</h4>
                  <p className="text-body-md text-on-surface-variant">
          ...
          <div className="lg:w-1/2 relative">
            ...
            {/* Precision Label */}
            <div className="absolute top-10 -right-4 bg-tertiary text-on-tertiary px-4 py-2 rounded-lg text-label-md rotate-3 shadow-lg">
      ...
      <section className="py-24 bg-primary-container text-on-primary-container overflow-hidden">
        <div className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
          <div className="mb-16">
            <h2 className="text-headline-lg mb-4 text-surface">The Datamore Impact</h2>
            <p className="text-body-md opacity-70">Measuring the tangible shift from intuition to intelligence.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter">
            {impactMetrics.map((metric, index) => (
              <div key={index} className="p-8 border-l border-outline-variant/30">
                <div className="text-display-lg mb-2 text-surface">{metric.value}</div>
                <div className="text-label-md uppercase tracking-wider mb-2">{metric.label}</div>
                <p className="text-body-md opacity-60">{metric.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-display-lg-mobile md:text-display-lg mb-8">{ctaTitle}</h2>
          <p className="text-body-lg text-on-surface-variant mb-12">{ctaSubtitle}</p>
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <button className="bg-secondary text-on-secondary px-10 py-5 rounded-lg text-label-md hover:brightness-110 shadow-xl transition-all">
              {primaryCTALabel}
            </button>
            <button className="glass-edge px-10 py-5 rounded-lg text-label-md hover:bg-surface-container transition-all">
              {secondaryCTALabel}
            </button>
          </div>
        </div>
