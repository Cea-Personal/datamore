...
<div className="hidden md:flex gap-gutter items-center">
          <Link 
            href="/services" 
            className={`${pathname === '/services' ? 'text-body-md text-secondary border-b-2 border-secondary pb-1' : 'text-body-md text-on-surface-variant hover:text-secondary transition-colors duration-200'}`}
          >
            Services
          </Link>
          <Link 
            href="/success-stories" 
            className={`${pathname === '/success-stories' ? 'text-body-md text-secondary border-b-2 border-secondary pb-1' : 'text-body-md text-on-surface-variant hover:text-secondary transition-colors duration-200'}`}
          >
            Success Stories
          </Link>
          <Link 
