    ...
    <section className="relative px-margin-mobile md:px-margin-desktop py-20 md:py-32 max-w-container-max mx-auto grid md:grid-cols-2 gap-12 items-center">
      <div className="z-10">
        ...
        <div className="flex gap-4">
          <a href="#talent-pool" className="bg-primary text-on-primary px-8 py-4 rounded-lg font-label-md hover:bg-secondary transition-all shadow-lg active:scale-95">
            View Mission
          </a>
          <a href="#values" className="border border-outline text-on-surface px-8 py-4 rounded-lg font-label-md hover:bg-surface-container transition-all active:scale-95">
            Our Values
          </a>
        </div>
      </div>
