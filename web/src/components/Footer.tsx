      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter mb-16">
          ...
          <div className="md:col-span-2">
            <h6 className="font-label-md text-label-md mb-6 text-white uppercase tracking-wider">Services</h6>
            <ul className="space-y-4">
              <li>
                <a href="#" className="font-body-md text-body-md opacity-70 hover:opacity-100 hover:text-tertiary-fixed transition-all">
                  Data Engineering
                </a>
              </li>
              <li>
          ...
          <div className="md:col-span-2">
            <h6 className="font-label-md text-label-md mb-6 text-white uppercase tracking-wider">Company</h6>
            <ul className="space-y-4">
              <li>
                <a href="#" className="font-body-md text-body-md opacity-70 hover:opacity-100 hover:text-tertiary-fixed transition-all">
                  Success Stories
          ...
          <div className="md:col-span-4">
            <h6 className="font-label-md text-label-md mb-6 text-white uppercase tracking-wider">Stay Updated</h6>
            <div className="flex gap-2">
              <input
                ...
                type="email"
              />
              <button className="bg-secondary text-white px-6 py-3 rounded-lg font-label-md text-label-md hover:bg-secondary/90 transition-colors">
                Join
              </button>
            </div>
          </div>
        ...
        <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <span className="font-body-md text-body-md opacity-60">© 2024 Datamore. All rights reserved.</span>
